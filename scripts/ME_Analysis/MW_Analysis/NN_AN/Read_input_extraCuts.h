...
void Input(const char *rootFile,int N1,nn_vars *var, tree_in *sim,TTree *simu, int fill,int sig1,int sig2, int cutt, double massH, int jetMulti)
{
...
tree->Add(rootFile);
 ...
 if (massH==115){
   tree->SetBranchAddress("Whi0_115",&Whi);
   tree->SetBranchAddress("Whi3_115",&Whi3);
   }
 if (massH==135){
   tree->SetBranchAddress("Whi0_135",&Whi);
   tree->SetBranchAddress("Whi3_135",&Whi3);
   }
 if (massH==130){
   tree->SetBranchAddress("Whi0_130",&Whi); 
   tree->SetBranchAddress("Whi3_130",&Whi3);
   } 
 if (massH==120){
   tree->SetBranchAddress("Whi0_120",&Whi); 
   tree->SetBranchAddress("Whi3_120",&Whi3);
   }
 ...
 for (int i=0;i<N1; ++i){	
   ...
   if(cutt==2 && MeTsig<10. && btagj1>0.679 && btagj2>0.679 && ((l1+l2).M()>76.) && ((l1+l2).M()<106.) ){evt[i]=true;}
   if(cutt==1 && MeTsig<10. && btagj1>0.679 && btagj2>0.679 ) {evt[i]=true;}
   if(cutt==0 && MeTsig<10. && ((l1+l2).M()>76.) && ((l1+l2).M()<106.) && btagj1>0.244 && btagj2>0.244 && ((b1+b2).M()>80.) && ((b1+b2).M()<150.)){
     if (jetMulti==0 && multiplicity==2){evt[i]=true;}
     if (jetMulti==1 && multiplicity>2){evt[i]=true;}
     }
   if(evt[i]==true){
