...
process.Zmmj = cms.EDProducer("CandViewShallowCloneCombiner",
                               decay = cms.string("Ztightloose selectedPatJets"),
                               cut = cms.string("mass > 0"),
                               name = cms.string('Zbb'),
...
process.Zmmb = cms.EDProducer("CandViewShallowCloneCombiner",
                               decay = cms.string("Ztightloose bjets"),
                               cut = cms.string("mass > 0"),
                               name = cms.string('Zbb'),
                               roles = cms.vstring('Z', 'b'),
                               checkCharge = cms.bool(False)
...
# Run it
process.p1 = cms.Path(process.hlt * process.scrapingVeto * process.patElectronIDs*process.patElectronIsolation * process.patDefaultSequence * process.mutrigger)
process.p2 = cms.Path(process.hlt * process.scrapingVeto* process.patElectronIDs*process.patElectronIsolation  * process.patDefaultSequence * process.eltrigger)
