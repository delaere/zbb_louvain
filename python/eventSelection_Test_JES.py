...
def selectedTriggers(triggerInfo):
  ...
  triggers = ("HLT_DoubleMu7_v3","HLT_Mu13_Mu8_v2","HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v4","HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v5")
...
def isTriggerOK(triggerInfo, muChannel=True, runNumber=None):
  ...
  if runNumber is None:
    if muChannel:
      triggers = ("HLT_DoubleMu7_v3","HLT_Mu13_Mu8_v2")      
    else:
