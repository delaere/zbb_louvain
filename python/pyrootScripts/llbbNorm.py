### Scripts where the normlisation factor are read from the database ###

### Get missing python modules in CMSSW 53X ###
import os, sys
...
### Get how to read the database ###
from UserCode.zbb_louvain.zbbSamples import *

totDYev = 46515036. # Sum of the 7 DY samples

### if the database is accessible read the cross-sections and number of generated events and compute the normalisation factor ###
try: 
    lumi = {
        "DATA"   : 19.7, # 8 TeV data
        ...
        "ZA_350_70"  : 25000./0.02/1000., # 2HDM typeII from SUSHi tanB=1.5, cos(T-B)=0.01
        "ZA_262_99"  : 25000./0.1112/1000, # 2HDM typeII from SUSHi tanB=1.5, cos(T-B)=0.01
        "ZA_286_93"  : 25000./0.09419/1000, # 2HDM typeII from SUSHi tanB=1.5, cos(T-B)=0.01
        }
except:
    ### default values obtained by dumping the above lumi map, be carful if you see the following Warning ###
