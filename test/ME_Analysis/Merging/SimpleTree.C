...
//    }
   ...
   //RDS location
   TString folderRDS = "/nfs/user/cbeluffi/RDS/rds5314p1/RDS_JP_fix/";
   TFile* f_RDS = new TFile(folderRDS+"File_rds_zbb_"+InputFile+".root");
   TTree* t_RDS = (TTree*) f_RDS->Get("rds_zbb");
   //tree2 input
   TString folderIn = "/nfs/user/cbeluffi/Tree2_537/";
   TString mename = folderIn+"ME_zbb_" + InputFile + "_comb.root";
   TFile* f_ME = new TFile(mename);
   TTree* t_ME = (TTree*)f_ME->Get("tree2");
   //out file
   TString folderOut = "/nfs/user/cbeluffi/Tree2_537/";
